    ...
    return (
      <Container>
        <Header style={{ backgroundColor: ACC_TEAL}}>
          ...
          <Body>
            <Title style={{ color: ACC_DARK_TEAL}}>Add ingredient</Title>
          </Body>
          <Right>
            {
        ...
        <Content style={{ backgroundColor: ACC_CREAM}} >
          ...
          <Button block style={{ backgroundColor: ACC_PEACH}} onPress={() => this.setState({viaBarcode: !this.state.viaBarcode})}>
              <Text style={{ color: ACC_DARK_PEACH}}>Scan barcode</Text>
          </Button>
          ...
          <Button block style={{ backgroundColor: ACC_PEACH}} onPress={this.toggleForm.bind(this)}>
              <Text style={{ color: ACC_DARK_PEACH}}>Add manually</Text>
          </Button>
